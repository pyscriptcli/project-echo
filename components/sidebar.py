...
def setup_page_layout():
    """
    Hides default Streamlit UI and renders a compact, sleek horizontal 
    ...
    /* 1. HIDE ALL DEFAULT STREAMLIT UI ARTIFACTS */
    ...
    /* 2. RECLAIM PAGE WIDTH & TIGHTEN PADDING */
    .block-container {
    ...
    /* 4. BASE LINK STYLING (Compact & Elegant) */
    ...
    /* 8. PURE SVG ICONS VIA CSS MASKS (Compact 16x16px) */
    ...
    # Render Compact Horizontal Navbar
    # Adjusted column ratios to hug the content tightly to the left
    col1, col2, col3, _ = st.columns([1.1, 1.1, 1.6, 6.2])
    with col1:
